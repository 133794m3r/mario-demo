...
function Map:update(dt)
    ...
    -- keep the player strictly within the playfield.
...
function Map:tileAt(x, y)
    -- TODO: convert X and Y in pixels to an X, Y tile position in our map
    -- HINT: self:getTile should come in handy
    -- HINT: math.floor will definitely come in handy
    -- HINT: don't forget that our map is 1-indexed!
